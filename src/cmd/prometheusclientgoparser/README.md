...
Currently the golang parser is failing some test cases that are passing in the python parser.
Here is a list of the failing tests:

```
FAIL test: bad_clashing_names_0
FAIL test: bad_clashing_names_1
FAIL test: bad_clashing_names_2
...
FAIL test: bad_exemplars_10
FAIL test: bad_exemplars_3
FAIL test: bad_exemplars_4
FAIL test: bad_exemplars_5
FAIL test: bad_exemplars_6
FAIL test: bad_exemplars_7
FAIL test: bad_exemplars_8
FAIL test: bad_exemplars_9
FAIL test: bad_exemplars_on_unallowed_metric_types_0
FAIL test: bad_exemplars_on_unallowed_metric_types_1
FAIL test: bad_exemplars_on_unallowed_metric_types_2
FAIL test: bad_exemplars_on_unallowed_samples_0
FAIL test: bad_exemplars_on_unallowed_samples_1
FAIL test: bad_exemplars_on_unallowed_samples_2
FAIL test: bad_exemplars_on_unallowed_samples_3
...
FAIL test: bad_timestamp_2
FAIL test: bad_timestamp_4
FAIL test: bad_timestamp_5
FAIL test: bad_timestamp_7
FAIL test: bad_timestamp_8
FAIL test: bad_unit_6
FAIL test: bad_unit_7
FAIL test: bad_value_4
FAIL test: bad_value_5
FAIL test: bad_value_6
FAILED passed=112, failed=93, total_failures=93
```
